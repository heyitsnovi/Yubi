<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="table-responsive">
							<div>
									<button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="#modal-invoice-open">
										<i class="fa fa-money"></i> Add Invoice</button>
							</div>
							<br>
							<div>					 
	...
	<script>
		...
		$('.btnsave-invoice').on('click',function(){
			$.ajax({
				url: '<?php echo base_url('ajax/add_invoice'); ?>',
				type: 'POST',
				data:{
					or: $('.or_num').val(),
					amt: $('.amt_paid').val(),
					stud: '<?php echo $student_id; ?>'
				},
				success:function(){
					location.reload();
				}
